...
public partial class AppDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.IdDispositivo).HasName("PK__Disposit__B1EDB8E4A68AFC5A");
        ...
        {
            entity.HasKey(e => e.IdLocal).HasName("PK__LocalDis__C287B9BB7BFB0BD9");
        ...
        {
            entity.HasKey(e => e.IdManutencao).HasName("PK__Manutenc__CD0C6B2A932EF663");
        ...
        {
            entity.HasKey(e => e.IdRegra).HasName("PK__RegraPer__E4F2CC24EDE48347");

            entity.ToTable("RegraPerfil");

            entity.HasIndex(e => e.Nome, "UQ__RegraPer__7D8FE3B20381DD95").IsUnique();
        ...
        {
            entity.HasKey(e => e.IdTipoDispositivo).HasName("PK__TipoDisp__A9EEE648C6D07FC1");
        ...
        {
            entity.HasKey(e => e.IdTipoManutencao).HasName("PK__TipoManu__BE62BE4E2FB75377");
        ...
        {
            entity.HasKey(e => e.IdUsuario).HasName("PK__Usuario__5B65BF977A4DDF22");

            entity.ToTable("Usuario");

            entity.HasIndex(e => e.Email, "UQ__Usuario__A9D10534AECA8E37").IsUnique();
